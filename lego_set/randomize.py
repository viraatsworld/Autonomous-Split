...
# Create an invisible plane to define the scatter area
scatter_surface = rep.create.plane(
    scale=(0.12, 0.2, 1),  # Match your x_range and y_range dimensions
    position=((-0.1 + 0.02)/2, (-0.1 + 0.1)/2, 0.0),  # Center of your area
...
with rep.trigger.on_frame():
    for node in prime_node:
        with node:
            ...
            surface_prims=[scatter_surface],
            check_for_collisions=True  # Built-in collision detection!
        )
